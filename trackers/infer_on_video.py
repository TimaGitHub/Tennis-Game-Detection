...
import torch
import cv2
from trackers.general import postprocess
...
#
# python infer_on_video.py --model_path "C:\Users\Acer\PycharmProjects\YOLO8TENNISANALYSIS\models\tracknet_model_best.pt" --video_path "C:\Users\Acer\PycharmP
# rojects\YOLO8TENNISANALYSIS\input_videos\input_video.mp4" --video_out_path "C:\Users\Acer\PycharmProjects\YOLO8T
# ENNISANALYSIS\output_videos\tracknet_output_video.avi"
...
def infer_model(frames, model):
    ...
    for num in tqdm(range(2, len(frames))):
        ...
        x_pred, y_pred = postprocess(output, scale=1)
...
def write_track(frames, ball_track, path_output_video, fps, trace=7):
    ...
    with open("C:\\Users\\Acer\\PycharmProjects\\YOLO8TENNISANALYSIS\\tracker_stubs\\tracknet_ball_detections.pkl", 'wb') as f:
